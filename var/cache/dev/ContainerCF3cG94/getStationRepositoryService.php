 ...
 */
class getStationRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StationRepository.php';

        return $container->privates['App\\Repository\\StationRepository'] = new \App\Repository\StationRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
