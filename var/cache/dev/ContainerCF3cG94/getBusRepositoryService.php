 ...
 */
class getBusRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BusRepository' shared autowired service.
     *
     * @return \App\Repository\BusRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BusRepository.php';

        return $container->privates['App\\Repository\\BusRepository'] = new \App\Repository\BusRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
