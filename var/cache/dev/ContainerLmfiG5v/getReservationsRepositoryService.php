...
class getReservationsRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ReservationsRepository.php';

        return $container->privates['App\\Repository\\ReservationsRepository'] = new \App\Repository\ReservationsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
