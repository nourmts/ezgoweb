 ...
 */
class getVoitureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VoitureRepository' shared autowired service.
     *
     * @return \App\Repository\VoitureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VoitureRepository.php';

        return $container->privates['App\\Repository\\VoitureRepository'] = new \App\Repository\VoitureRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
