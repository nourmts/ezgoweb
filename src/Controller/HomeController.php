...
final class HomeController extends AbstractController
{
    ...
    {
        // Retrieve the Ticket object by ID using the injected entity manager
        ...
        // Assuming you can get the Bus object via the Ticket object
        $bus = $ticket->getBus(); // Replace with actual method to get Bus if different
    ...
    ->build();
        ...
        // Optionally return the image as a response
    }
    ...
    public function purchaseTicket(
        ...
        try {
            ...
            // Envoi d'email après achat du ticket
            $email = (new Email())
                ->from('mohamedaljia006@gmail.com')
                ->to('algiamohamed22@gmail.com')
            ...
            try {
                $logger->info('Attempting to send email with configuration: ' . $_ENV['MAILER_DSN']);
                $mailer->send($email);
                $logger->info('Email sent successfully to algiamohamed22@gmail.com');
            ...
            return new JsonResponse([
                ...
                'ticket' => [
                    ...
                    'qrCodeUrl' => $qrCodeUrl,  // Add the comma here
